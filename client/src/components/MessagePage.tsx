...
export const MessagePage: React.FC = () => {
  ...
  const handleUploadImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      setMessage((prevValue) => ({ ...prevValue, imageUrl: uploadPhoto.url }));
    }
  };
  ...
  const handleUploadVideo = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      setMessage((prevValue) => ({ ...prevValue, videoUrl: uploadVideo.url }));
    }
  };
  ...
  const handleOnChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setMessage((prevValue) => ({ ...prevValue, text: e.target.value }));
  };
      ...
      <section className="h-16 bg-white flex items-center px-4">
        <div className="relative ">
          <button
            ...
            className="flex justify-center items-center  w-11 h-11 rounded-full hover:bg-primary hover:text-white cursor-pointer"
          >
            <FaPlus size={20} />
          </button>
